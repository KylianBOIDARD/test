...
// buffer_start début du buffer
// buffer_end fin du buffer
// buffer_in adresse premier élement
// buffer_out adresse dernier élément
...
// Incrementation du pointeur du buffer d'écriture
	...
	if (strlen(commande_recu) != 0 && c== 0x0D)
	{
		...
		//serOutstring("\n\r Traitement \n\r");
			...
			if (traitement_commande()){
				...
				serOutstring("\r\n>");
				//EA = 0;
				// Envoie de l'ordre au serializer à ajouter
				//EA = 1;
