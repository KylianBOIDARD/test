...
typedef struct COMMANDES_SERIALIZER COMMANDES_SERIALIZER ;// Cette structure contient toutes les commandes à envoyer au serializer
...
typedef struct INFORMATIONS_SERIALIZER INFORMATIONS_SERIALIZER ; // Cette structure contient toutes les informations envoyées par la carte Serialize
	                                     // Les variables de type enum correspondent aux commandes
                                       // Les variables de type BYTE, UNSIGNED_BYTE ou int corrspondent aux paramètres
